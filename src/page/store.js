...
function Store(props) {
  ...
  return (
    <div className="h-screen">
      ...
      <div className="bg-white" style={{margin:"0vh 5% 5% 5%", paddingTop:"146px"}}>
        <div className="grid gap-12 grid-cols-1 2xl:grid-cols-5 xl:grid-cols-4 md:grid-cols-3 sm:grid-cols-2 xs:grid-cols-1 justify-items-center">
