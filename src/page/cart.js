...
const Cart = (card_props)=>{
    ...
    useEffect((event)=>{
        if(checkFirstGetCart === true){
            axios.get(global_url_token.url+'/getCart/'+localStorage.getItem("token"))
    ...
    return (
        <div className="h-[100vh] bg-[#FFE5A3]">
            <div className="h-16"/>
            <div className="font-prompt flex justify-center" style={{}}>
                <div className="flex max-h-[85vh] flex-col p-8 m-8 bg-white rounded-xl shadow-xl min-w-[44.25%] w-[97%] 2xl:w-[44.25%] xl:w-[53.1%] lg:w-[66.375%] md:w-[88.5%] sm:w-[95%] xs:w-[97%]" style={{}}>
                    <h1 className="text-xl font-bold mb-2" style={{color:"#E54E3D"}}>ตะกร้าของคุณ</h1>
                    <div className="justify-left overflow-y-auto" style={{marginTop:"1vw"}}>
