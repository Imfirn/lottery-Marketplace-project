            ...
            <div className="flex" style={{marginLeft:"1vw", width:"100%"}}>
                ...
                <div style={{marginLeft:"2.5vw", height:"100%", width:"100%"}}>
                    ...
                    <div style={{display:"flex", justifyContent:"space-between",height:"20%"}}>
                        <div style={{height:"50%"}}>
                            <p style={{display: "flex-end"}}>จำนวน: {card_props.cardInfo.Amount} ใบ <span className={card_props.cardInfo.Stock!== undefined ? "have-stock" : "no-stock"}>&emsp;(คงเหลือ {card_props.cardInfo.Stock} ใบ)</span></p>
                        </div>
                        <div style={{}}>
                            <p style={{marginRight:"1vw"}}><span style={{fontSize:"2rem"}}>{Number(card_props.cardInfo.Amount) * 80}</span> บาท</p>
                        </div>
                    </div>
                </div>
            </div>
