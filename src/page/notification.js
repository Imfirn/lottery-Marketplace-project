  ...
  return (
    <div className="h-screen bg-[#FFE5A3] font-prompt">
      ...
      <div className=" flex justify-center">
        <div className="flex flex-col p-8 m-8 bg-white min-w-[44.25%] w-[97%] 2xl:w-[44.25%] xl:w-[53.1%] lg:w-[66.375%] md:w-[88.5%] sm:w-[95%] xs:w-[97%] rounded-xl shadow-xl max-h-[85vh]"> 
          <div className="">
          ...
          <div className=" h-max-[85vh] overflow-auto">
            {infoNoti.map((Info) => (
              <div className=" m-5">
