...
const Register = () => {
    ...
    axios
      ...
      .then(function (response) {
        ...
        if (response.data.status === "200OK") {
          ...
          formErrors["UserName"] = "ชื่อผู้ใช้นี้ถูกใช้งานแล้ว";
        } else if (response.data.status === "200EM") {
          formErrors["Email"] = "อีเมลนี้ถูกใช้งานแล้ว";
  ...
  const validate = (values) => {
    ...
    if (password === "") {
      ...
      errors["Password"] =
        "กรุณากรอกเฉพาะอักขระภาษาอังกฤษ ตัวเลข หรือ \"!@#$%^&*=\"";
    ...
    } else if (!/^[1-9][0-9]{4}$/.test(zipCode)) {
