...
function App() {
  ...
  useEffect(() => {
    ...
    // setIsShow(!(tempToken === undefined || tempToken === null || tempToken === "undefined" || tempToken === "null"))
      ...
      <Dropdown isOpen={isOpen} toggle={toggle}/>
        <Routes>
          <Route path="/" exact element={
            localStorage.getItem("token") === undefined || localStorage.getItem("token") === null || localStorage.getItem("token") === "undefined" || localStorage.getItem("token") === "null"? (
              <Navigate to="/login"/>
            ) : (
              <Navigate to="/home"/>
            )
          ...
          <Route path="/account"  element={<Account order_ID = {getOrderID}/>}/>
